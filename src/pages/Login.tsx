        ...
        <Card className="card-taxi animate-slide-up p-6">
          <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                      ...
                      {isLogin && (
                          <button 
                              ...
                              className="text-xs font-bold text-muted-foreground hover:text-primary transition-colors hover:underline"
                          >
                              Forgot Password?
                          </button>
                      )}
            ...
            <Button 
                type="button" 
                variant="outline" 
                className="w-full h-12 rounded-xl border-2 hover:bg-slate-50 font-bold flex items-center justify-center space-x-2"
